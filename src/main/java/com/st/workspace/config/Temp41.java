...
//        for (Object objWorkspace : workspaces.keySet()) {
////            String workspaceId = toString(objWorkspace);
//            Map<String, Object> workspaceItems = (Map<String, Object>) workspaces.get(objWorkspace);
//
//            Workspace.Chart chart = toChart(workspaceItems);
